// Standalone dashboard executable — serves the React SPA + mock API
// on a single port. No external dependencies, no installation required.
//
// Usage: just run the .exe — dashboard available at http://localhost:3001
package main
...
func spaHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		index, err := staticAssets.Open("build/index.html")
		if err != nil {
			http.Error(w, "Dashboard not available", 503)
			return
		}
		defer index.Close()
		w.Header().Set("Content-Type", "text/html; charset=utf-8")
...
func weeklyData(resource, anchorDate string) []WeeklySummary {
	...
	for i := range rows {
		...
		rows[i] = WeeklySummary{
			Date: d.Format("2006-01-02"), Day: d.Format("Mon"), Plan: plan,
...
var stationScenarios = map[string]stationScenario{
	"WM16": {
		prodRows: []ProductionRow{
			...
			{Hour: 21, Plan: 23, Actual: 17, GoodCount: 17, ScrapCount: 0, Gap: 6, CycleTime: 152.3},
		},
		dtEvents: []DowntimeEvent{
...
var marsProduction = []map[string]any{
	{"WorkOrder": "WO-20240610-02", "PartNumber": "BMW1000D-360", "Revision": "C", "PlannedQty": 184, "ActualQty": 150, "PlannedStart": "14:00", "ActualStart": "14:02", "PlannedEnd": "22:00", "ActualEnd": "", "Status": "IN_PROGRESS"},
	{"WorkOrder": "WO-20240610-01", "PartNumber": "BMW1000D-360", "Revision": "C", "PlannedQty": 184, "ActualQty": 184, "PlannedStart": "06:00", "ActualStart": "06:01", "PlannedEnd": "14:00", "ActualEnd": "13:58", "Status": "COMPLETED"},
}
...
var marsSchedule = []map[string]any{
	{"WorkOrder": "WO-20240610-03", "PartNumber": "BMW1000D-360", "Revision": "C", "PlannedQty": 184, "scheduled_date": "2026-06-11", "ShiftNum": 2},
	{"WorkOrder": "WO-20240611-01", "PartNumber": "BMW2000E-180", "Revision": "A", "PlannedQty": 160, "scheduled_date": "2026-06-11", "ShiftNum": 1},
	{"WorkOrder": "WO-20240611-02", "PartNumber": "BMW3000F-240", "Revision": "B", "PlannedQty": 140, "scheduled_date": "2026-06-12", "ShiftNum": 2},
}
...
func handleHealth(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, deployment.HealthPayload(deployment.Mode()))
}
...
// Production mode inserts and reads notes using this SQL Server schema:
//
...
func main() {
	...
	fmt.Printf("  Stations: WM15–WM24 | Shift 2 | JPH target: %d\n", jphTarget)
	fmt.Printf("  Tabs: Stations · Production · Productivity · Issues · Downtime\n")
